function speech (tabela){
	var tabela= [
		...
		mv= mv+tabela[i2][2];
			...
			var s= new SpeechSynthesisUtterance(tabela);
s.lang="pt-BR"
s.rate=1
s.pitch=2.9
return s;
}
//speechSynthesis.speak(speech(s));
var button= document.querySelector("button")
button.onclick= function (){
speechSynthesis.speak(speech("a média de visitas é",mv," existem",cm," homens e ",cf,"mulheres que vão ao parque."));
}